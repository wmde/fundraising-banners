	...
	<div class="wmde-banner-message">
		<div>
			...
			<p>
				...
				to 25 years of knowledge, humanity, and collaboration at its best. Most readers donate because
				Wikipedia is useful to them, others because they realize knowledge needs humans. If you feel the same,
				please donate €5 now—or consider a yearly gift to help all year. Thank you.
			</p>
		</div>
	</div>
</template>

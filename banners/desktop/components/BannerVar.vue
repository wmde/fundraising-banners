<template>
	<div class="wmde-banner-wrapper" :class="contentState" :style="[ { '--wmde-full-banner-delay': `${fullBannerDelay}ms` },  colors ]">
		<EarlyBanner v-if="contentState === ContentStates.Main" @close="() => onCloseMain( 'EarlyBanner', CloseChoices.Close )"/>
		<MainBanner
		...
		>
			...
			<template #banner-slides="{ play }: any">
				<KeenSlider :with-navigation="true" :play="play" :interval="10000" :delay="9500" :navigation-color="'#ffffff'">
...
import EarlyBanner from './EarlyBanner.vue';

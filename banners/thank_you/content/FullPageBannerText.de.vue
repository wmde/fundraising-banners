<template>
	...
	<p> Rund { numberOfDonors } großartige Menschen haben in den letzten 57 Tagen auf unsere Spendenbitte reagiert
		...
		macht uns allen zu schaffen. Und dennoch konnten wir unser Spendenziel wieder erreichen.
		<strong>Dafür danken wir Ihnen allen von ganzem Herzen!</strong>
	</p>
	...
	<p>
		Sie können das heute ändern:
		<strong>Wir laden Sie herzlich ein, diesem Kreis von außergewöhnlichen Menschen als neues Fördermitglied beizutreten.</strong>
		Bereits mit 2 Euro im Monat sind Sie dabei. Helfen Sie, die Unabhängigkeit der Wikipedia zu stärken und ihre

<template>
	<div class="wmde-b-slider" @mousedown="stopAutoplay" @touchstart="stopAutoplay">
		<div ref="container" class="keen-slider wmde-b-slider__slides">
			<slot name="slides" :currentSlide="currentSlide"/>
		</div>

		<button v-if="withNavigation" type="button" class="wmde-b-slider__previous-slide">
			<slot name="previous-slide-icon">
				<ChevronLeftIcon/>
			</slot>
		</button>
		<button v-if="withNavigation" type="button" class="wmde-b-slider__next-slide">

...
const messages: TranslationMessages = {
	...
	'form-1-legend': 'Vielen Dank für Ihre Hilfe',
	'form-3-legend': 'Wie möchten Sie heute {{amount}} {{interval}} spenden?',
	'form-button-next': 'Weiter',
	'back-button-amount': 'Betrag ändern',
	'back-button-interval': 'Häufigkeit ändern',
	'interval-0': 'einmalig',

<template>
	<h2>Danke, wir haben es geschafft! Aber es war knapper denn je. </h2>
	...
	<div class="wmde-banner-content-columns">
		...
		<p>
			Deshalb unsere Bitte: <strong class="highlight">Werden auch Sie Teil dieser Gemeinschaft von Wikipedia-begeisterten Menschen</strong>

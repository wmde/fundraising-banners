<template>
	...
	>
		...
		<div class="wmde-banner-form-transaction-fee" v-show="numericAmount > 0 && transactionFee > 0">
			<input type="checkbox" value="1" name="cover-transaction-fee" id="wmde-banner-form-cover-transaction-costs" v-model="hasTransactionFee">

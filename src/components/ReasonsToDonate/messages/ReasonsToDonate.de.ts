...
const translations: TranslationMessages = {
	...
	'reasons-2-title': 'Danke sagen',
	'reasons-2-content': 'Mit Ihrer Spende zeigen Sie den vielen tausend Freiwilligen, die Wikipedia schreiben, Ihre Wertschätzung.' +
	...
	'reasons-final-content': '<strong>Überzeugt?</strong> Ganz gleich, ob Sie „Ihre“ Wikipedia unterstützen, die wichtige Rolle der' +

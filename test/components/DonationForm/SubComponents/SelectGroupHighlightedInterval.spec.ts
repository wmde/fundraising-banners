...
import SelectGroupHighlightedInterval from '@src/components/DonationForm/SubComponents/SelectGroupHighlightedInterval.vue';

const translate = ( key: string ): string => key;

describe( 'SelectGroupHighlightedInterval.vue', () => {
	let wrapper: VueWrapper<any>;

	beforeEach( () => {
		wrapper = shallowMount( SelectGroupHighlightedInterval, {
			props: {
				fieldName: 'interval',
				isValid: true,
				selectionItems: [
